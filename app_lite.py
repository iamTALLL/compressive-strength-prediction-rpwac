...
logging.getLogger("mealpy.swarm_based.FOX").setLevel(logging.WARNING)
...
# OPTIMIZATION CONFIG
# =========================================================
USE_MEALPY_OPTIMIZER = os.getenv("USE_MEALPY_OPTIMIZER", "0") == "1"
MAX_RETRIES = int(os.getenv("OPT_MAX_RETRIES", "1"))
EPOCH_BASE = int(os.getenv("OPT_EPOCH_BASE", "8"))
EPOCH_RETRY = int(os.getenv("OPT_EPOCH_RETRY", "12"))
POP_SIZE = int(os.getenv("OPT_POP_SIZE", "8"))
OPT_RANDOM_SAMPLES = int(os.getenv("OPT_RANDOM_SAMPLES", "220"))
OPT_LOCAL_SAMPLES = int(os.getenv("OPT_LOCAL_SAMPLES", "80"))
OPTIMIZE_TIMEOUT_SECONDS = int(os.getenv("OPT_TIMEOUT_SECONDS", "18"))
